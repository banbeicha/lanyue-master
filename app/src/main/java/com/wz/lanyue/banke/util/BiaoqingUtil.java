 ...
 */
public class BiaoqingUtil implements Serializable{
public  static Map<String,Integer> emojiMap=new HashMap<String,Integer>();
static {
    ...
    emojiMap.put("[打哈欠]", R.mipmap.d_dahaqi);
